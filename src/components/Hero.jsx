export default function Hero() {
    return (
        <section className="overflow-hidden">
            <img src="/assets/background/banner.png" className="absolute sm:top-72 top-72 lg:top-42 -z-10 w-full h-[375px] lg:h-screen" alt="" />
            <div className="bg-[#E8F4FB] h-[375px] w-full absolute -z-10"></div>
            <div className="p-8 md:p-16 lg:p-20 flex flex-col lg:flex-row gap-15 justify-center">
                <div className="flex-1">
                    <h1 className="font-bold text-3xl md:text-5xl text-neutral-800 mb-5  lg:leading-14">Dukung Program Dakwah Syiar Qur’an Project.</h1>
                    ...
                    <div className="flex flex-wrap gap-10 lg:grid-cols-3">
                ...
                <div className="flex-1 grid grid-cols-2 lg:w-[524px]">
                    <div>
